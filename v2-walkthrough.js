...
(async () => {
  ...
  await pg.evaluate(() => (window.__SP_DEBUG.useBase('ex-customers'), document.getElementById('nav-compare').click())); await pg.waitForTimeout(500); t = await side();
  ...
  await pg.evaluate(() => (window.__SP_DEBUG.useBase('ex-mix'), document.getElementById('nav-compare').click())); await pg.waitForTimeout(500); t = await side();
  ...
  await click('#nav-company'); await pg.evaluate(() => window.__SP_DEBUG.useBase('full')); await pg.waitForTimeout(400); await scrub(20); await click('#menu-mech');
  const views = [];

...
(async () => {
  ...
  step('Where is the company at month 36, and what do the ARR-only KPIs say?',
       ['World: ARR physics (the frozen Base). Company lens, month 36, MRR basis.'].concat(desc(t, ['MRR', 'cash · trough €6.10m at M13', 'EBITA margin · R12M', 'gross margin · law'])).concat(rows(t, ['Opening', '+ new MRR', '− leakage⋈ 90%', '+ expansion⋈ 10%', 'Closing', 'gross dollar retention · R12M', 'net dollar retention · R12M', 'persistence', 'Revenue', 'Gross profit', 'EBITA', 'cohort M36 · 37 alive'])));

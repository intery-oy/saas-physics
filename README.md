...
| **Cohorts** | Which vintage is carrying/leaking the book — and is blended NRR lying? Composition + honesty strip + age-profile toggle. |
...
node cohorts-checks.js      # Cohorts v1: composition totals, honesty strip, age profile, no invented math
...
- [`docs/COHORTS.md`](docs/COHORTS.md) — Cohorts v1: composition + honesty + age toggle

...
- [`docs/WALKTHROUGH-V2.md`](docs/WALKTHROUGH-V2.md) — **practical use**: a CFO's questions asked
  of the built page through its real controls, answers read off the screen (regenerated by
  `node v2-walkthrough.js`)
